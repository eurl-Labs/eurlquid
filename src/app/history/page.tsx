...
export default function HistoryPage() {
  ...
  const { swaps, loading, error, refetch, refreshKey, isConnected, address } =
    useUserTradingHistory(selectedDex);
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-white/10">
                  {swaps.map((swap: Swap, index) => {
                    ...
                    const tokenOut = swap.token_out
                      ? getTokenDisplay(swap.token_out)
                      : null;
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm">
                          <button
                            onClick={() =>
                              openTransaction(swap.transaction_hash)
                            }
                          ...
                          >
                            <span className="text-xs font-mono">
                              {formatTxHash(swap.transaction_hash)}
                            </span>
