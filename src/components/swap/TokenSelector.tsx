...
export function TokenSelector({
  ...
  const selectedTokenData = SWAP_TOKENS.find(
    (token) => token.symbol === selectedToken
  );

  // Filter tokens based on search query
  const filteredTokens = SWAP_TOKENS.filter(
    (token) =>
  ...
  return (
    <>
      ...
      >
        ...
        <span className="text-sm text-white font-medium">{selectedToken}</span>
        <motion.div
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-white/60">
                            Choose token for {label.toLowerCase()}
                          </p>
                        </div>
                      </div>
                      <motion.button
                            ...
                            return (
                              ...
                              >
                                <TokenListItem
                                  ...
                                  onSelect={() =>
                                    !isDisabled && handleTokenSelect(token)
                                  }
                                />
                              </motion.div>
                            );
...
function TokenListItem({
  ...
  return (
    <motion.button
      ...
      whileHover={
        !isDisabled
          ? { scale: 1.01, backgroundColor: "rgba(255,255,255,0.15)" }
          : {}
      }
